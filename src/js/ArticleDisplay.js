class ArticleDisplay {
    ...
    displayArticle(title, html) {
        ...
        this.container.style.cssText = 'display: flex; flex-direction: column; flex: 1; overflow: hidden;';
    ...
    _isWikipediaLink(href, rel) {
        return (rel && rel.includes('mw:WikiLink')) || 
               (href && (
    ...
    _extractArticleTitle(href, title, rel, link) {
        ...
        // Clean up the title
        return decodeURIComponent(articleTitle)
            .replace(/_/g, ' ')
            .split('#')[0];
    }
